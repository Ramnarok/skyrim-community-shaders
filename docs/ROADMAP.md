...
| M7 | Actors (skinning) + alpha-tested geometry | 🔄 M7a skinned actors ✅ + M7b FaceGen heads ✅ tested 2026-09-24 (depth mismatch incl. actors 0.001–0.03%); **uncommitted**. Next: M7c foliage alpha test (v2 texture path). See ARCHITECTURE §4 "M7". |
