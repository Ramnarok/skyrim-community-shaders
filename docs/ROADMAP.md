...
3. **Soft shadows from the light's size.** Lights are points today; sample a point on a small sphere (fixture-dependent radius) so shadows soften with distance from the blocker, as the sun's cone already does.
