...
4. **Emissive surfaces as lights** (glowing mushrooms, embers, lava): GI and reflection rays that hit a glowing surface add its emission. Census verified 2026-09-25; step 2 (emission at GI / reflection hits, glow maps per texel) built 2026-09-25, not yet verified in game (ARCHITECTURE §5 "M9": acceptance criteria there).
